...
const Sidebar = ({ showSidebar, toggleSidebar }) => {
  ...
  return (
    <div
      className={`${
        showSidebar ? "w-64" : "w-[88px]"
      } px-4 sidebar bg-primary h-full  relative duration-300 no-scrollbar overflow-auto `}
    >
      <div className="h-[75px] text-3xl font-bold w-full px-2  py-6 whitespace-nowrap shrink-0 flex gap-4">
        <span>
          <i
            className="fa-solid fa-book fa-lg"
            style={{ color: "#ffffff" }}
          ></i>
        </span>
          ...
          <li className="w-full overflow-hidden capitalize py-4 shrink-0  ">
            ...
            >
              ...
              <span
                ...
                } text-base origin-left duration-200 flex justify-between items-center w-full`}
              >
                Dashboard
              </span>
            </Link>
