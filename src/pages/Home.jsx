    ...
    <div className='w-full h-full '>
      <div className='flex flex-col gap-10'>
        ...
        <div className='bg-white self-stretch rounded-lg p-4'>
          ...
          <div className='w-full flex flex-col md:flex-row flex-wrap items-start gap-4 '>
            
            {/* card 1 */}
            <div className='self-stretch md:flex-1 bg-[#f4f4f4] p-3 rounded-xl shadow-lg'>
              <div className='bg-primary relative flex justify-center items-center mb-3 w-[80px] p-4 rounded-lg'>
                <span>
                <i className="fa-solid fa-chart-simple" style={{color:"#fafcff"}}></i>
                </span>
            ...
            <div className='self-stretch md:flex-1 bg-[#f4f4f4] p-3 rounded-xl shadow-lg'>
              <div className='bg-[#4CA750] relative flex justify-center items-center mb-3 w-[80px] p-4 rounded-lg'>
                <span>
                <i className="fa-solid fa-chart-line" style={{color:"#fafcff"}}></i>
                </span>
            ...
            <div className='self-stretch md:flex-1 bg-[#f4f4f4]  p-3 rounded-xl shadow-lg'>
              <div className='bg-[#DF2869] relative flex justify-center items-center mb-3 w-[80px] p-4 rounded-lg'>
                <span>
                <i className="fa-solid fa-user-plus" style={{color:"#fafcff"}}></i>
                </span>
            ...
            <div className='self-stretch md:flex-1 bg-[#f4f4f4]  p-3 rounded-xl shadow-lg'>
              <div className='bg-[#328BEC] relative flex justify-center items-center mb-3 w-[80px] p-4 rounded-lg'>
                <span>
                <i className="fa-solid fa-solid fa-dollar-sign" style={{color:"#fafcff"}}></i>
                </span>
        ...
        {/* charts */}
        <div className='self-stretch flex flex-col md:flex-row gap-5'>
